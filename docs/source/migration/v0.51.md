...
(repo root, gitignored) confirmed 13 of 18 claims; refuted 3; left 2
undecided. v0.51 ships fixes for the 13 confirmed claims; 2 (R8-G3,
R8-G4) are deferred to v1.x as Tier-2 additive (filed in
`audit_findings.md` Round 8 ledger).
