...
| Hidden Leaks in Time Series Forecasting | Yan et al. (2025) | arXiv preprint | arXiv:2512.06932 | — | Identifies subtle leakage modes in modern time-series forecasting pipelines (target-aware preprocessing, future-aware feature engineering, sliding-window misuse) | Extends Bergmeir 2012 / Roberts 2017 with modern time-series leakage modes; provides detection guidelines beyond classical CV-validity arguments |
