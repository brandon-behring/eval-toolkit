...
| HackAPrompt × SQuAD: Naive-Dedup Detection for Prompt-Injection Benchmarks | (2025) | arXiv preprint | arXiv:2505.04806 | — | Naive-dedup detection between PI benchmarks (HackAPrompt, SQuAD adversarials) and pretraining corpora; quantifies attack-success-rate inflation when benchmark prompts appear in training data | First systematic measurement of PI-benchmark naive-dedup contamination; recommends strict normalization and per-benchmark contamination disclosure for PI eval (extends Sainz 2023 to the PI setting) |
