...
### 1. Exact duplicates {#exact-duplicates}
...
### 2. Near duplicates {#near-duplicates}
...
### 3. Encoding-obfuscated duplicates (NEW in v0.7.0) {#encoding-obfuscation}
...
### 4. Cross-split (train ↔ eval) leakage {#cross-split}
...
### 5. Label conflict {#label-conflict}
...
### 7. Temporal leakage {#temporal-leakage}
...
### 8. Target / pretraining / distribution-shift leakage {#target-leakage}
...
## PyTorch & transformer-specific pitfalls {#pytorch-pitfalls}
