...
### Target precision (NEW in v0.7.0) {#target-precision}
...
### Cost-sensitive (Bayes-optimal) {#cost-sensitive}
...
## When to refit threshold per bootstrap resample {#bootstrap-refit}
