...
## Why a separate artifact layer? {#why}
...
### PredictionColumns {#prediction-columns}
...
### PredictionArtifactRef {#artifact-ref}
...
## MetricState vs error_metric helpers {#metric-state-vs-error}
...
## The `validation` extra and validate_payload {#validation}
