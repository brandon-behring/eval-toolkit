...
## Holdout vs K-fold {#holdout-vs-kfold}
...
## Group-disjoint K-fold {#group-kfold}
...
## Source-disjoint K-fold (NEW in v0.7.0) {#source-disjoint-kfold}
...
## Time-aware splits {#time-series-splits}
...
## When CV alone is insufficient {#cv-and-ood}
