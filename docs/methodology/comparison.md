...
## Single-condition CI: BCa vs percentile {#bca-vs-percentile}
...
## Operating-point differences (two-level bootstrap) {#two-level-bootstrap}
...
## MDE: "we couldn't detect a difference" claims {#mde}
...
## What's NOT in eval-toolkit (and why) {#out-of-scope}
