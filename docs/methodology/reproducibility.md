...
## A reproducible run, end-to-end {#end-to-end}
...
## Manifest fields ↔ NeurIPS Reproducibility Checklist {#neurips-mapping}
...
## PyTorch determinism — the sharp edges {#pytorch-determinism}
