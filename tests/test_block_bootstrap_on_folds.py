...
def test_block_bootstrap_on_folds_returns_correct_shape_and_method() -> None:
    ...
    ci = block_bootstrap_on_folds(folds, n_resamples=1000, seed=42)
...
def test_block_bootstrap_on_folds_wider_when_fold_variance_high() -> None:
    ...
    ci_low = block_bootstrap_on_folds(low_var, n_resamples=2000, seed=42)
    ci_high = block_bootstrap_on_folds(high_var, n_resamples=2000, seed=42)
...
def test_block_bootstrap_on_folds_seed_reproducibility() -> None:
    ...
    ci_a = block_bootstrap_on_folds(folds, n_resamples=500, seed=42)
    ci_b = block_bootstrap_on_folds(folds, n_resamples=500, seed=42)
...
def test_block_bootstrap_on_folds_vs_cv_clt_ci_both_bracket_mean() -> None:
    ...
    ci_block = block_bootstrap_on_folds(folds, n_resamples=2000, seed=42)
